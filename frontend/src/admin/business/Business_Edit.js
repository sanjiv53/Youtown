...
export default function Product() {
    ...
    const [newItem, setNewItem] = useState({
        Businessname:itemToEdit.Businessname|| '',
 ...
 const navigate = useNavigate();
    ...
    const existingImagetwo =itemToEdit.userImage || '';
      ...
      const handleEditSubmit = (e) => {
        ...
        axios.put(`${apiUrl}/businesssignEdit/${editingItememail}`, newItem) // Assume newItem contains the ID of the item being edited
            .then(response => {
                ...
                setNewItem({ name: '', email: '',phone1:'', password: '' }); // Reset form
            })
            .catch(error => {
                ...
                <div className={styleadmin.rightpanel}>
                    ...
                    <div className={styleadmin.business_add_box}>
                        ...
                        <form onSubmit={handleCombinedSubmit}>
                            <h2 style={{ textAlign: 'center' }}>Edit Business Profile</h2><br />
                            ...
                            <h2 style={{ textAlign: 'center' }}>Edit  Profile</h2><br />
                            <div className={styleadmin.business_box}>
                                <div>
                                    <label> Name</label><br />
                                    <input
