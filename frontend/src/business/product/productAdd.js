    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:5000/product', formData, {
            ...
            .then(response => {
                ...
                setNewItem({ name: '', description: '', order: '', Category: '', subCategory: '', Qty: '', price: '', Vendor: '' });  // Reset form
                setFile(null);
                navigate('/businessproduct');
                NotificationManager.success('Add Product successfully', 'Success');
            })
            .catch(error => {
         ...
         <NotificationContainer />
            <div className={styles.information}>
                <form onSubmit={handleSubmit} className={styles.form} >
                    <h1 style={{ textAlign: 'center' }}>Product Add</h1>
