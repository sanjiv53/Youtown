...
export default function Productdetails() {
 ...
 useEffect(() => {
    if (itemToEdit?.Vendor) {
      ...
      fetch(`http://localhost:5000/getbusinessproperty?name=${itemToEdit.Vendor._id}`)
        .then((response) => {
          if (!response.ok) {
      ...
      <div>
        ...
        <div className={styletwo.product_about_details}>
          ...
          <div className={styletwo.product_about}>
            ...
            <h5>Property Type: {itemToEdit.order}</h5>
            <h5>Number of Rooms: {itemToEdit.size}</h5>
       ...
       src={mapSrc}
        ...
        <h1 style={{ textAlign: 'center' }}>Property <span style={{ color: 'red' }}> Sale </span></h1>
